  ...
  <div class="content-page">
      <div class="content-nav">
          <el-breadcrumb class="breadcrumb" separator="/">
              ...
              <el-breadcrumb-item>新手指南设置</el-breadcrumb-item>
          </el-breadcrumb>
  ...
  methods: {
    DisRulesUpdate() {
      ...
      this.$confirm('此操作将修改此信息，立即生效！, 是否继续?', '提示', {
         ...
         this.axios.post('guide/setnoviceguide',{
    ...
    findInfo() {
      this.axios.post('guide/findnoviceguideinfo').then(res => {
        console.log(res);
    ...
    detailhandlesuccess(res, file) {
      ...
      if (res) {
        ...
        quill.insertEmbed(length, 'image', 'http://resource.shop.com/' + res.key)
        // 调整光标到最后
