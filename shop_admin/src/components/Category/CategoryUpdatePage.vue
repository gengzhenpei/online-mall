  ...
  export default {
    ...
    methods: {
      ...
      handleIndexBarSuccess(res,file) {
        ...
        this.infoForm.index_bar_imageUrl = 'http://resource.shop.com/'+ res.key
      },
      handleCateGoryImgSuccess(res,file) {
        console.log(res,file);
        this.infoForm.catrgory_normal_imageUrl = 'http://resource.shop.com/'+ res.key
      },
      handleIndexCateGoryImgSuccess(res,file) {
        console.log(res,file);
        this.infoForm.index_catrgory_normal_imageUrl = 'http://resource.shop.com/'+ res.key
      },
      // abc() {
